...
export default function AdminPanel({}: AdminPanelProps) {
  ...
  useEffect(() => {
    ...
    const channel = supabase
      ...
      .on('postgres_changes', { event: '*', schema: 'public', table: 'content_items' }, fetchContentData)
      .on('postgres_changes', { event: '*', schema: 'public', table: 'team_content_submissions' }, fetchContentData)
      .on('postgres_changes', { event: '*', schema: 'public', table: 'team_credentials' }, fetchTeamCredentials)
